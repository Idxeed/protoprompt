...
```bash
python -m pip install "protoprompt[documents,fastapi,ollama]==0.8.0"
python -m pip install "git+https://github.com/Idxeed/protoprompt.git@v0.8.0#subdirectory=apps/ollama-chat"
```
